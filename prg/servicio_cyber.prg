...
PUBLIC Vgc_clic,Vgn_opt,Vgc_cliente2,conex,Vgn_tipousu,Vgc_serie,Vgc_nomb_usu,Vgn_actual,fg_conectado,Vgn_super_user,VPC_llave,Vpn_ID_FACTURA_VENTA,Vpn_ID_FACTURA 
Vpn_ID_FACTURA_VENTA=0
Vpn_ID_FACTURA=0
Vgn_super_user=0
fg_conectado=0
Vgn_actual=0
...
cnControladorArch = FOPEN(lcAppDir+"configV2.txt")
...
_screen.visible = .f.
do FORM servicio_cyber
read event
_screen.visible = .t.

*DO FORM servicio_sunat
*READ EVENTS	
